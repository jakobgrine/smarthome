...
var out='<!DOCTYPE html><html> <head> <title>Zuhause</title> <meta name="viewport" content="width=device-width,initial-scale=1.0"> <link rel="stylesheet" href="dashboard.css"> <script src="index.js" defer></script> </head> <body> <main> ';var arr1=it.cards;if(arr1){var c,i1=-1,l1=arr1.length-1;while(i1<l1){c=arr1[i1+=1];out+=' <div class="card"> <h1>'+(c.title)+'</h1> ';var arr2=c.entities;if(arr2){var e,i2=-1,l2=arr2.length-1;while(i2<l2){e=arr2[i2+=1];out+='  '; e.state = it.states[e.id]; out+=' <div class="entity"> <span>'+(e.name)+'</span> ';if(e.type === 'switch'){out+='  <div class="binary-sensor';if(e.state){out+=' checked';}out+='"></div> <img src="onoff.svg" id="'+(e.id)+'" class="toggle-button" onclick="onSwitchToggle(this)"> ';}else if(e.type === 'binary_sensor'){out+='  <div id="'+(e.id)+'" class="binary-sensor';if(e.state){out+=' checked';}out+='"></div> ';}out+=' </div> ';} } out+=' </div> ';} } out+=' </main> <div id="disconnect-message">Verbindung getrennt. Verbinde erneut…</div> </body></html>';return out;
